...
def test_a_whole_note_embed_leaves_the_marked_sections_behind(tmp_path: Path) -> None:
    build_tree(
        tmp_path,
        TreeLayout("""
            in
...
def test_an_embed_naming_a_marked_section_still_gets_it(tmp_path: Path) -> None:
    build_tree(
        tmp_path,
        TreeLayout("""
            in
...
def test_a_marked_section_is_dropped_from_a_mirrored_note(tmp_path: Path) -> None:
    build_tree(
        tmp_path,
        TreeLayout("""
            in
...
def test_a_dangling_link_inside_a_marked_section_does_not_fail_the_run(
    tmp_path: Path,
) -> None:
    build_tree(
        tmp_path,
...
def test_marked_sections_are_left_behind_at_any_embed_depth(tmp_path: Path) -> None:
    build_tree(
        tmp_path,
        TreeLayout("""
            in
